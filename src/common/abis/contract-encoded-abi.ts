...
//    *
//    * @param {ContractEncodedAbiMongoModel} document - The document containing the encoded ABI data.
//    * @returns {ContractEncodedAbi} A new ContractEncodedAbi instance.
//    */
//   public static fromDocument(document: ContractEncodedAbiMongoModel): ContractEncodedAbi {
...
//    *
//    * @returns {ContractEncodedAbiMongoModel} The ContractEncodedAbi instance as a document.
//    */
//   public toDocument(): ContractEncodedAbiMongoModel {
